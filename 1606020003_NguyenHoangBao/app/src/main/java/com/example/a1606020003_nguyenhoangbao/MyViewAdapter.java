...
//    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            this.edtid = (EditText) itemView.findViewById(R.id.subjectID);
            this.edtprice = (EditText)itemView.findViewById(R.id.subject_code);
            this.edtname = (EditText)itemView.findViewById(R.id.credits);
            this.edtproducer = (EditText)itemView.findViewById(R.id.subject_name);
            this.edtdescription = (EditText)itemView.findViewById(R.id.description);
        }
